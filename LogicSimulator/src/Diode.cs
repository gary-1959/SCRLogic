...
namespace SharpCircuit {
	...
	public class Diode {
		...
		public double leakage = 1e-10; // was 1e-9, changed to 1e-14, changed back by CONTRELEC to aid convergence;
		...
		public void doStep(Circuit sim, double voltdiff) {
			...
			if(Math.Abs(voltdiff - lastvoltdiff) > 0.1) // changed to 0.1 by CONTRELEC to improve convergence
				sim.converged = false;
